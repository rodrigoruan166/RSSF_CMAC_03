...
if __name__ == "__main__":
    ARQUIVO_COORDENADAS = "100.txt"
    NUM_RODADAS = 200 # altere
    ...
    plt.tight_layout()
    plt.savefig("comparacao_protocolos_2x2.png")
    ...
    plt.xlabel(f"Índice da simulação - {ARQUIVO_COORDENADAS.replace('.txt', '')} Sensores")
    ...
    plt.tight_layout()
    plt.savefig("vida_util_barras_simulacoes.png")
    plt.show()
